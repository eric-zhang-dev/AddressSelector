...
public class FileUtil {
	 ...
	 */	public static String getDataPath() {
		if (MemorySpaceCheckUtil.checkSDCard()) {
			return FileUtil.SDCard + "/Android/data/" + App.getInstance().getPackageName() + "/";
			// return FileUtil.SDCard+"/";
		} else {
			return "/data/data/" + App.getInstance().getPackageName() + "/";
		}
	}
